...
> В данном проекте для тестирования и демонстрации используются исторические и симулируемые потоки данных, так как доступ к реальным городским API датчиков трафика в реальном времени ограничен. Алгоритмы полностью функциональны и готовы к интеграции с реальными источниками данных (ITS API).

### Ключевые возможности

- 🧠 **Настоящая LSTM (PyTorch)** — глубокая нейросеть для анализа временных рядов и прогнозирования трендов.
- 📊 **Интеллектуальный мониторинг** — система анализа краткосрочных прогнозов с использованием ML и статистических методов.
- 🗺️ **Цифровой двойник (Digital Twin)** — What-If сценарии для моделирования перекрытий дорог.
