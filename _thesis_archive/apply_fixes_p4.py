...
try:
    ...
    print("Replaced Table 4")
except Exception as e:
    print(f"Error 4: {e}")

try:
    headers8 = ['Модель', 'MAE', 'RMSE']
    data8 = [[k, v[0], v[1]] for k, v in metrics['30'].items() if k in ['Naive', 'Trend LR', 'Random Forest', 'LSTM', 'AI Brain (Ensemble)']]
    replace_table_with_new(doc, 8, headers8, data8)
    print("Replaced Table 8")
except Exception as e:
    print(f"Error 8: {e}")
...
try:
    ...
    print("Replaced Table 10 (Horizon 15)")
except Exception as e:
    print(f"Error 10: {e}")
...
try:
    ...
    print("Replaced Table 13")
except Exception as e:
    print(f"Error 13: {e}")

try:
    # Delete corrupted Table 14 completely
    tbl14 = doc.tables[14]
    tbl14._tbl.getparent().remove(tbl14._tbl)
    print("Deleted corrupted Table 14")
except Exception as e:
    print(f"Error deleting 14: {e}")
